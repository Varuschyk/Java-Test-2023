package com.alexvar.testOverviewApplication.test.contants.service.order;
...
@UtilityClass
public class TestOrderServiceConstants {
  ...
  public final long ORDER_HOLDER_DELETE_UNPAID_ORDERS_MILLISECONDS = 1000;
